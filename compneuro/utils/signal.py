...
def convolve(
    ...
    Raises:
        compneuro.errors.CompNeuroUtilsError: raised if any one of the following
          happens:
    ...
    if t_h is None:
        ...
        if t_h.ndim != 1:
            raise err.CompNeuroUtilsError("t_h must be 1-D")
        dt_h = t_h[1] - t_h[0]
    ...
    if t_u is None:
        ...
        if t_u.ndim != 1:
            raise err.CompNeuroUtilsError("t_u must be 1-D")
        dt_u = t_u[1] - t_u[0]
